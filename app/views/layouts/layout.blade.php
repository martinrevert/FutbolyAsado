				...
				<div class="col-md-12">
					...
					<div class="navbar navbar-default">
						<div class="navbar-header">
							...
							<a class="navbar-brand" style="font-family: MiFont" href="http://www.futbolyasado.com"><i class="fa fa-home"></i>Futbol y Asado</a>
						</div>
						...
						<div class="navbar-collapse collapse">
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-user"></i> {{{ $data['name'] }}}<span class="caret"></span></a>
